...
<!-- 업체코드는 시퀀스로 얻기 -->
	<form action="register" method="post" enctype="multipart/form-data">
		...
		<div id="content">
			...
			<input type="text" name="sName" placeholder="가게명">
			<br/><br/>
			...
			<!-- 사업자번호 추가하기 -->
			<input type="tel" name="bNo" pattern="[0-9]{3}-[0-9]{2}-[0-9]{5}" required placeholder="사업자 번호 : 000-00-00000">
			<br/><br/>
			...
			<input type="text" id="lat" name="sLat" placeholder="위도" style="display:none">
			<input type="text" id="lng" name="sLng" placeholder="경도" style="display:none">
			
			<input type="search" id="address" name="sAd" placeholder="주소를 설정해주세요.">
			<br/>
			...
			<b>가게전화번호</b><br/>
			<input type="tel" name="sPhone" placeholder="02-000-0000">
			<br/><br/>
			...
			<input type="text" name="user_id" placeholder="회원아이디">
			<br/><br/>
