...
<div class="container">
	<form action="apply" method="post">
		...
		<div id="content">
			...
			<input type="text" name="asName" placeholder="가게명">
			<br/><br/>
			...
			<!-- 한글주소가 자동으로 입력됨 -->
			<input type="search" id="address" name="asAd" placeholder="현재위치를 검색하여 주소를 설정해주세요." readonly>
			<br/>
			...
			<b>가게전화번호</b><br/>
			<input type="tel" name="asPhone" placeholder="02-000-0000">
			<br/><br/>
			...
			<input type="text" name="user_id" placeholder="회원아이디"> <!-- 로그인시 로그인한 아이디로 입력되게해야함 화면에는 숨기고 -->
			<br/><br/>
